...
TEST_F(VkPositiveLayerTest, RenderPassSingleMipTransition) {
    ...
    VkSubpassDescription subpass = {
        ...
        .pColorAttachments = &att_refs[0],
        .pResolveAttachments = nullptr,
        .pDepthStencilAttachment = &att_refs[1],
    ...
    depthImage.Init(32, 32, 2, VK_FORMAT_D32_SFLOAT, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_IMAGE_TILING_OPTIMAL, 0);
    ...
    colorImage.TrackLayout(VK_IMAGE_LAYOUT_GENERAL);
    ...
    depthImage.TrackLayout(VK_IMAGE_LAYOUT_GENERAL);
